...
//   const handleNestedChange = <T extends { id: number }>(
...
//                       {proj.link && <Button variant="link" as="a" href={proj.link} target="_blank" className="p-0">View Project</Button>}
//                     </div>
//                   </div>
//                 ))}
//               </div>
